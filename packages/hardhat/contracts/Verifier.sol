...
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            qo: Honk.G1Point({ 
               x: uint256(0x27abff61513acca570b8e4850d6f4a46c2f027e2c9fcdf659cc54bbc59518aad),
               y: uint256(0x23101a7ad21da48a51c10f3e2840169c51f13e8aff1dcb14b4f6555f9f3cdde0)
            }),
            q4: Honk.G1Point({ 
            ...
            qm: Honk.G1Point({ 
               x: uint256(0x046b12a64e623094f5b4a3e6fcd8c8654294655dd06e535a98a0a797117e38ec),
               y: uint256(0x2f39b3dfae8cea01dda76fbedeb8216e496b1b90ae169010645d9a3cc19de0c5)
            }),
            qc: Honk.G1Point({ 
